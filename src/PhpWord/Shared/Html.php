...
class Html
{
     ...
     */
    public static function addHtml($element, $html, $fullHTML = false, $preserveWhiteSpace = true, $options = array()): void
    {
    ...
    protected static function parseNode($node, $element, $styles = [], $data = []): void
    {
        ...
        $nodes = [
            ...
            'h1' => ['Heading',     $node,   $element,   $styles,    null,   "Heading{$u}1",     null],
            'h2' => ['Heading',     $node,   $element,   $styles,    null,   "Heading{$u}2",     null],
            'h3' => ['Heading',     $node,   $element,   $styles,    null,   "Heading{$u}3",     null],
            'h4' => ['Heading',     $node,   $element,   $styles,    null,   "Heading{$u}4",     null],
            'h5' => ['Heading',     $node,   $element,   $styles,    null,   "Heading{$u}5",     null],
            'h6' => ['Heading',     $node,   $element,   $styles,    null,   "Heading{$u}6",     null],
